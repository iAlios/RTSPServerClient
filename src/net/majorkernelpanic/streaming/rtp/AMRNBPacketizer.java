...
/**
 * RFC 3267. AMR Streaming over RTP. Must be fed with an InputStream containing
 * raw amr nb Stream must begin with a 6 bytes long header: "#!AMR\n", it will
 * be skipped
 */
public class AMRNBPacketizer extends AbstractPacketizer implements Runnable {
	...
	private static final int AMR_FRAME_HEADER_LENGTH = 1; // Each frame has a
														  // short header
	private static final int[] sFrameBits = {
